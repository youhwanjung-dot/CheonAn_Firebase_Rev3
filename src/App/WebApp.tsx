...
const WebApp = () => {
    ...
    const executeReset = async () => {
        try {
            ...
            console.error("Web Reset: Failed to reset database:", error);
        }
